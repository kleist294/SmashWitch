...
static Vertex3D g_CubeVertexs[] =
{
	...
	{{ 0.5f,-0.5f,0.5f} ,{0.0f,0.0f,1.0f},D3DCOLOR_RGBA(255,255,255,255),{0.0f,0.249f}},
	{{-0.5f,0.5f ,0.5f} ,{0.0f,0.0f,1.0f},D3DCOLOR_RGBA(255,255,255,255),{0.25f,0.0f}},
	//	{{-0.5f, 0.5f,0.5f} ,{0.0f,0.0f,1.0f},D3DCOLOR_RGBA(255,255,255,255),{0.25f,0.0f}},
	{{-0.5f,-0.5f ,0.5f},{0.0f,0.0f,1.0f},D3DCOLOR_RGBA(255,255,255,255),{0.25f,0.249f}},
	...
	{{-0.5f,-0.5f, 0.5f},{-1.0f,0.0f,0.0f},D3DCOLOR_RGBA(255,255,255,255),{0.0f,0.249f} },
	{{-0.5f, 0.5f,-0.5f},{-1.0f,0.0f,0.0f},D3DCOLOR_RGBA(255,255,255,255),{0.25f,0.0f} },
	//	{{-0.5f, 0.5f,-0.5f},{-1.0f,0.0f,0.0f},D3DCOLOR_RGBA(255,255,255,255),{0.25f,0.0f} },
	{{-0.5f,-0.5f,-0.5f},{-1.0f,0.0f,0.0f},D3DCOLOR_RGBA(255,255,255,255),{0.25f,0.249f}},
	...
	//	{{0.5f,-0.5f,-0.5f},{1.0f,0.0f,0.0f},D3DCOLOR_RGBA(255,255,255,255),{0.0f,0.25f} },
	//up
	{{-0.5f, 0.5f, 0.5f},{0.0f,1.0f,0.0f},D3DCOLOR_RGBA(255,255,255,255),{0.01f,0.0f}  },
	{{-0.5f, 0.5f,-0.5f},{0.0f,1.0f,0.0f},D3DCOLOR_RGBA(255,255,255,255),{0.01f,0.25f} },
...
void SkyBox_Init() 
{
	g_TextureID = Texture_SetTextureLoadFile("asset\\texture\\skybox2.png");

	const D3DXVECTOR2 UV_offset[] =
	{ D3DXVECTOR2(0.0f,0.251f) ,D3DXVECTOR2(0.25f,0.251f) ,D3DXVECTOR2(0.5f,0.251f) ,D3DXVECTOR2(0.75f,0.251f), D3DXVECTOR2(0.25f,0.01f) ,D3DXVECTOR2(0.25f,0.5f) };
